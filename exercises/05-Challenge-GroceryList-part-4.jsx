...
class GroceryList extends React.Component {
  ...
  toggleGroceryCompleteness(groceryIndex) {
    ...
    state.groceries[groceryIndex].completed = !state.groceries[groceryIndex].completed;
    this.setState(state);
  }
  ...
  render() {
    ...
    newProductAddButton = <button className='add-product' onClick={this.addGroceryItem} disabled={!this.state.newGroceryName}>Add new Product</button>;
